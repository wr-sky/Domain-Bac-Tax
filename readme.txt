...
7-data
    ...
    -- json_edgelist: Including two files, json and edgelist. The json file contains documents recording the distance of each pair of species; The edgelist file contains documents recording the MST structures.
